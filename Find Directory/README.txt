### Installation Instructions Find Directory
...
2. Copy & Paste the Open_fd file:
   - Copy the Open_fd paste into the plugins folder.
...
7. open nuke:
   ...
   -Restart the Nuke and now you can enjoy the Find Directory on the above toolbars.
